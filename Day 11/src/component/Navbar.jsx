  ...
  return (
    <div className='w-[100%] h-[100px] flex justify-center items-center'>
        <ul className='w-[500px] h-[100%] flex justify-evenly items-center font-bold'>
            ...
            <li><NavLink className={({isActive})=> isActive ? 'border border-black ps-3 pe-3 pt-1 pb-1 rounded bg-black text-white' : ''} to='/signup'>Signup</NavLink></li>
            <li><NavLink className={({isActive})=> isActive ? 'border border-black ps-3 pe-3 pt-1 pb-1 rounded bg-black text-white' : ''} to='/login'>Login</NavLink></li>
            ...
            <li><NavLink className={({isActive})=> isActive ? 'border border-black ps-3 pe-3 pt-1 pb-1 rounded bg-black text-white' : ''} to='/cart'>Cart</NavLink></li>
